                      ...
                      <table width="90%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <div style="line-height: 44px;">
                              <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
                                <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                                  You are just one step away from completing your sign-up process on Munttoo, click on the button below to verify your email address -
                                </span>
                              </font>
                            </div>
                            <!-- padding -->
                        ...
                        <tr>
                          <td style="padding-bottom:30px; height:80px" class="">
                            <a href="{{ $verification_link }}" target="_blank" style="font-family: Helvetica, Arial, sans-serif; text-decoration: none;color: #fff; font-size: 18px; line-height:22px; padding: 14px 18px 14px 18px; background:#009ada; border-radius:10px; margin-bottom:100px" >
